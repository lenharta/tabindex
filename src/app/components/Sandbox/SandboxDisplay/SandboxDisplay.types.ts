...
export type TFactorySandboxDisplayPanel = Factory<{
  props: IPropsSandboxDisplayPanel;
  ref: HTMLDivElement;
}>;

export type TFactorySandboxDisplayAction = Factory<{
  props: IPropsSandboxDisplayAction;
  ref: HTMLButtonElement;
}>;

export type TFactorySandboxDisplayActionMenu = Factory<{
  props: IPropsSandboxDisplayActionMenu;
  ref: HTMLDivElement;
}>;
